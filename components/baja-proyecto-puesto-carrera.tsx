...
import { ArrowLeft, Trash2, GraduationCap, Users, Clock, Calendar } from "lucide-react"
...
interface BajaProyectoPuestoCarreraProps {
  carrera: ProyectoPuestoCarrera
  onSave: (carrera: ProyectoPuestoCarrera) => void
  onCancel: () => void
}

export function BajaProyectoPuestoCarrera({ carrera, onSave, onCancel }: BajaProyectoPuestoCarreraProps) {
  const handleConfirm = () => {
    ...
    const updatedCarrera: ProyectoPuestoCarrera = {
      ...carrera,
      fechaBajaProyectoPuestoCarrera: formattedDate,
    }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card>
          <CardContent className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">¿Desea dar de baja la carrera?</h2>
              <p className="text-gray-600">Revise la información de la carrera antes de confirmar la baja</p>
            </div>
            ...
            <div className="mb-8">
              <div className="flex items-center mb-2">
                ...
                <span className="text-gray-600 text-sm">Carrera a dar de baja</span>
              </div>
            ...
            <div className="mb-8">
              <div className="flex items-center mb-4">
                ...
                <span className="font-medium text-gray-900">Información de la carrera</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{carrera.materiasRegulares}</p>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{carrera.planEstudios}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <p className="text-sm text-red-600 mt-1">
                  La carrera será marcada como inactiva y no estará disponible para nuevas postulaciones.
                </p>
              </div>
            </div>
